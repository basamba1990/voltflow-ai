-- ============================================
-- INITIAL SETUP FOR VOLTFLOW AI (CLEAN & SAFE)
-- ============================================
...
-- ============================================
-- 3. DROP EXISTING POLICIES (CRITICAL)
-- ============================================

DROP POLICY IF EXISTS "Users can view own profile" ON public.profiles;
DROP POLICY IF EXISTS "Users can update own profile" ON public.profiles;
DROP POLICY IF EXISTS "Service role can manage all users" ON public.profiles;
...
DROP POLICY IF EXISTS "Service role can manage all simulations" ON public.simulations;

DROP POLICY IF EXISTS "Users can view own simulation results" ON public.simulation_results;
DROP POLICY IF EXISTS "Service role can insert simulation results" ON public.simulation_results;

DROP POLICY IF EXISTS "Everyone can view public materials" ON public.materials;
DROP POLICY IF EXISTS "Users can manage own materials" ON public.materials;

DROP POLICY IF EXISTS "Users can manage own geometry files" ON storage.objects;
...
CREATE POLICY "Users can manage own geometry files"
ON storage.objects
FOR ALL
USING (
