...
ins_sim AS (
  ...
  SELECT
    gen_random_uuid(), 'e0f72d33-7e94-4cba-bffc-9959be7a30d7'::uuid, 'Simulation de Test - Réparation', 'Ceci est une simulation de test créée par le script de réparation', 'simple',
